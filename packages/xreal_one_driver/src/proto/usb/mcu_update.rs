...
use crate::proto::usb::{Empty, RequestArgs, UsbDevice, UsbInboundMessage, UsbTransaction};
use anyhow::bail;
...
impl UsbDevice {
    ...
    pub async fn update_mcu_with_progress(
        ...
        self.send_message::<McuUpdateKernelFinish>(Empty).await?;
    ...
    pub async fn update_recovery_mcu_with_progress(
        ...
        self.send_message::<McuRecoveryUpdateArm>(McuRecoveryUpdateArmRequest)
            .await?;

        self.send_message::<McuRecoveryUpdateStart>(header).await?;
        ...
        while position < update.len() {
            ...
            self.send_message::<McuRecoveryUpdateTransmit>(RawRequest(
        ...
        self.send_message::<McuRecoveryUpdateFinish>(Empty).await?;
